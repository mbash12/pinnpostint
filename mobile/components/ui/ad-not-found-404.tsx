...
interface AdNotFound404Props {
  onSearchAds?: () => void;
}

export function AdNotFound404({ onSearchAds }: AdNotFound404Props) {
  ...
  return (
    <NotFound404
      title="Ad Not Found"
      message="This ad is no longer available, has been removed, or the link is broken."
