...
interface BlogNotFound404Props {
  onBrowseBlog?: () => void;
}

export function BlogNotFound404({ onBrowseBlog }: BlogNotFound404Props) {
  ...
  return (
    <NotFound404
      ...
      message="This article is no longer available, has been removed, or the link is broken."
