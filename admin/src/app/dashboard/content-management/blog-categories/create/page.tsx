...
import { useCreateBlogCategory } from "@/hooks/use-blog";
...
export default function CreateBlogCategoryPage() {
    ...
    const handleChange = (field: string, value: any) => {
        ...
        if (["name", "slug"].includes(field)) {
            validateFieldValue(field, value, blogCategoryValidationSchema);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isValid = validateFormData(formState, blogCategoryValidationSchema);
        if (!isValid) {
        ...
        try {
            ...
            if (result?.success) {
                showAlert("Category Created", "Blog category has been successfully created.", "success");
    ...
    return (
        <FormLayout breadcrumb="Content management" title="Create Blog Category">
