...
export const TextAreaBase = ({ className, maxLength, ...props }: TextAreaBaseProps) => {
    return (
        <AriaTextArea
            {...props}
            maxLength={maxLength}
        ...
        >
            {({ isInvalid, isRequired }) => (
                <>
                    ...
                    <TextAreaBase placeholder={placeholder} className={textAreaClassName} ref={textAreaRef} rows={rows} cols={cols} maxLength={maxLength} />
