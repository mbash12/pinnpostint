                ...
                {({ state }) => (
                    <>
                        <AriaButton
                            ...
                            onPress={() => state.close()}
                            className="fixed top-3 right-2 z-[60] flex cursor-pointer items-center justify-center rounded-lg p-2 text-fg-white/70 outline-focus-ring hover:bg-white/10 hover:text-fg-white focus-visible:outline-2 focus-visible:outline-offset-2"
                        >
                            <CloseIcon className="size-6" />
                        </AriaButton>

                        <AriaModal className="w-full cursor-auto will-change-transform">
                            <AriaDialog className="h-dvh w-full max-w-sm overflow-y-auto outline-hidden focus:outline-hidden">
                                {children}
                            </AriaDialog>
                        </AriaModal>
                    </>
